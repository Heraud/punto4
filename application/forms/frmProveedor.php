...
class Application_Form_frmProveedor extends Zend_Form
{
    public function init()
    {
       // Traducción de errores de Zend/Validate
        ...
        $this->setAttrib('id', 'frmProveedor');
        ...
        $this->addElement(
                ...
                'validators' => array(
                    'Digits',
                    array('StringLength', false, array(8, 15))),
                'required'=>true,
