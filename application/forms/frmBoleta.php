...
class Application_Form_frmBoleta extends Zend_Form
{
       ...
       // Traducción de errores de Zend/Validate
        ...
        $this->addElement(
                ...
                'validators' => array(
                    'Int'),
                'required'=>true,
                'placeholder'=>'Ingrese el nro de boleta',
                'class'=>'input-large' 
                )
            );


        $date = new ZendX_JQuery_Form_Element_DatePicker('bo_fech');
